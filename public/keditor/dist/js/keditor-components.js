            ...
            (i.a.components.form = {
                ...
                (i.a.components.photo = {
                    ...
                    initSettingForm: function (t, o) {
                        ...
                        o.options;
                        t.append(
                            '<form id="myForm" class="form-horizontal" enctype="multipart/form-data">   <div class="form-group">       <div class="col-sm-12">   ' +
                            '        <button type="button" class="btn btn-block btn-primary" id="photo-edit">Change Photo</button> ' +
                            '          <input type="file" id="image-file"  style="display: none" />       </div>   </div>  ' +
                            ' <div class="form-group">     ' +
                        ...
                        n.on("click", function (t) {
                            ...
                            i.on("change", function () {
                                var bu=this
                                let pic = 'elnur';
                                let url='/admin/page/imageUpload'
                                let formData = new FormData();
                                let photo = document.getElementById("image-file").files[0];
                                formData.append("photo", photo);
                                console.log(pic)
                                var request=  axios.post(url,formData).then(function (res) {


                                    pic = res.data.imgName
