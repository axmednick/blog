...
<!-- Mirrored from axilthemes.com/demo/template/papr/index.html by HTTrack Website Copier/3.x [XR&CO'2010], Wed, 29 Jul 2020 19:33:33 GMT -->
<head>
    <!-- Basic metas
        ======================================== -->
    <meta charset="utf-8">
    ...
    <meta name="msapplication-TileImage" content="a{{url('/')}}/ssets/favicon/ms-icon-144x144.png">
    <meta name="theme-color" content="#ffffff">
    <!-- Icon fonts
        ======================================== -->
    <link href="https://fonts.googleapis.com/css?family=Roboto:300,400,500,500i,700,700i,900" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="{{url('/')}}/assets/css/fontawesome-all.min.css">
    <link rel="stylesheet" type="text/css" href="{{url('/')}}/assets/css/iconfont.css">
    <!-- css links
        ======================================== -->
    <!-- Bootstrap link -->
    ...
    <!-- Magnific popup -->
    <link rel="stylesheet" type="text/css" href="{{url('/')}}/assets/css/vendor/magnific-popup.css">
    <!-- Animate css -->
    <link rel="stylesheet" type="text/css" href="{{url('/')}}/assets/css/vendor/animate.css">
                    ...
                    <div class="col-md-auto">
                        <div class="footer-social-share-wrapper">
                            <div class="footer-social-share">
                                <div class="axil-social-title">{{__('index.social_network')}}</div>
...
<script src="{{url('/')}}/assets/js/vendor/jquery-migrate.min.js"></script>
<!-- jQuery Easing Plugin -->
<script src="{{url('/')}}/assets/js/vendor/easing-1.3.js"></script>
<!-- Waypoints js -->
...
<!-- Counter up js -->
<script src="{{url('/')}}/assets/js/vendor/jquery.counterup.js"></script>
<!-- Magnific Popup js -->
<script src="{{url('/')}}/assets/js/vendor/jquery.magnific-popup.min.js"></script>
<!-- Nicescroll js -->
<script src="{{url('/')}}/assets/js/vendor/jquery.nicescroll.min.js"></script>
<!-- IF ie -->
...
<!-- Mirrored from axilthemes.com/demo/template/papr/index.html by HTTrack Website Copier/3.x [XR&CO'2010], Wed, 29 Jul 2020 19:37:24 GMT -->
</html>
